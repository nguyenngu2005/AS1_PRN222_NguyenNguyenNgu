...
namespace Repositories.Repositories
{
    public class NewsArticleRepository : INewsArticleRepository
    {
        ...
        public List<NewsArticle> SearchNewsArticles(string keyword)
            => NewsArticleDAO.Instance.SearchNewsArticles(_context, keyword);
        ...
        public List<NewsArticle> GetNewsArticlesByCreator(short accountId)
            => NewsArticleDAO.Instance.GetNewsArticlesByCreator(_context, accountId);

        public List<NewsArticle> SearchNewsArticlesByCreator(short accountId, string keyword)
            => NewsArticleDAO.Instance.SearchNewsArticlesByCreator(_context, accountId, keyword);
